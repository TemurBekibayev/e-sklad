...
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe /target:exe /out:PrintHelper.exe /win32icon:launcher\app.ico /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Web.Extensions.dll launcher\PrintHelper.cs
if %errorlevel% neq 0 (
...
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe /target:winexe /out:KafePOS.exe /win32icon:launcher\app.ico /r:System.Windows.Forms.dll /r:System.Drawing.dll launcher\KafePOS.cs
