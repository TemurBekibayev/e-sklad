...
class Hall(BaseTenantModel):
    ...
    service_percent = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('0.00'), verbose_name="Xizmat foizi (%)")
...
class TableStatus(models.TextChoices):
    FREE = 'free', 'Bosh'
    BUSY = 'busy', 'Band'
    BILL_REQUESTED = 'bill_requested', 'Hisob soralgan'
    RESERVED = 'reserved', 'Bron qilingan'

class Table(BaseTenantModel):
    hall = models.ForeignKey(Hall, on_delete=models.SET_NULL, null=True, blank=True, related_name='tables', verbose_name="Zal")
    number = models.IntegerField(verbose_name="Stol raqami")
    name = models.CharField(max_length=100, verbose_name="Stol nomi")
    capacity = models.IntegerField(default=4, verbose_name="Sigimi")
    status = models.CharField(max_length=20, choices=TableStatus.choices, default=TableStatus.FREE, db_index=True, verbose_name="Holati")
    current_waiter = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='current_tables', verbose_name="Ofitsiant")
    ...
    class Meta:
        ...
        ordering = ['number']
        indexes = [models.Index(fields=['tenant', 'status']), models.Index(fields=['tenant', 'number'])]
...
class Order(BaseTenantModel):
    ...
    table = models.ForeignKey(Table, on_delete=models.CASCADE, related_name='orders', verbose_name="Stol")
    waiter = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='cafe_orders', verbose_name="Ofitsiant")
    waiter_name = models.CharField(max_length=150, blank=True, default='', verbose_name="Ofitsiant ismi")
    status = models.CharField(max_length=20, choices=OrderStatus.choices, default=OrderStatus.OPEN, db_index=True, verbose_name="Buyurtma holati")
    service_percent = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('0.00'), verbose_name="Xizmat foizi")
    service_amount = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Xizmat haqi")
    discount_percent = models.DecimalField(max_digits=5, decimal_places=2, default=Decimal('0.00'), verbose_name="Chegirma foizi")
    discount_amount = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Chegirma summasi")
    subtotal = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Taomlar summasi")
    total_amount = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Jami tolov")
    payment_method = models.CharField(max_length=20, choices=PaymentMethod.choices, default=PaymentMethod.CASH, verbose_name="Tolov usuli")
    cash_amount = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Naqd summa")
    card_amount = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Karta summa")
    ...
    class Meta:
        ...
        ordering = ['-created_at']
        indexes = [models.Index(fields=['tenant', 'status']), models.Index(fields=['tenant', 'created_at']), models.Index(fields=['tenant', 'table', 'status'])]
...
class OrderItem(BaseTenantModel):
    ...
    product = models.ForeignKey(Product, on_delete=models.SET_NULL, null=True, blank=True, related_name='cafe_order_items', verbose_name="Mahsulot")
    ...
    status = models.CharField(max_length=20, choices=OrderItemStatus.choices, default=OrderItemStatus.NEW, verbose_name="Holati")
    ...
    class Meta:
        ...
        ordering = ['created_at']
        indexes = [models.Index(fields=['tenant', 'order']), models.Index(fields=['tenant', 'status'])]
...
class Shift(BaseTenantModel):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='cafe_shifts', verbose_name="Kassir")
    ...
    opening_cash = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal('0.00'), verbose_name="Boshlangich naqd")
    ...
    status = models.CharField(max_length=20, choices=[('open', 'Ochiq'), ('closed', 'Yopilgan')], default='open', verbose_name="Holati")
